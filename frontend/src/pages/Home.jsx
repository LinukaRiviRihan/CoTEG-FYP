...
export default function Home() {
  ...
  const exampleSentences = [
    ...
    {
      label: 'Moment 1: Empty Nest',
      value:
        "Watching my daughter drive away to college... I've never been so proud, yet the house feels so empty and quiet now.",
    },

    {
      label: 'Moment 2: Post-Exam',
      value: 'I am so glad the exam is finally over.',
    },
    {
      label: 'Moment 3: Bump in the Night',
      value:
        'I heard a loud crash downstairs at 2 AM. I froze in bed, my heart stopped, and I realized I forgot to lock the back door.',
    },
    {
      label: 'Moment 4: Burnout',
      value:
        'I was beaming with pride as I handed in the final project, though internally my mind was so broken and burned out that I just wanted to lock myself in a dark room and cry.',
    },
  ];
  ...
  const currentSelectionLabel =
    exampleSentences.find((e) => e.value === text)?.label ||
    exampleSentences[0].label;
          ...
          <div className="max-w-2xl mx-auto px-4" ref={dropdownRef}>
            <div className="relative">
              <button
                ...
                <svg
                  className={`w-4 h-4 text-gray-500 shrink-0 transition-transform duration-200 ${isDropdownOpen ? 'rotate-180' : ''}`}
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24">
                  <path
